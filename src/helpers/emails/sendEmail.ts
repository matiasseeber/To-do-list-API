...
export async function sendEmail(email: string, subject: string, templateName: String, replacements: any) {
    ...
    let transporter = nodemailer.createTransport({
        service: "gmail" || process.env.emailService, // Your email service (e.g., Gmail, Outlook)
        auth: {
